 ...
 $servername = "localhost";
    ...
    {   		
                ...
                if (isset($arr_airport)&& isset($dep_airport))
                {
                    ...
                    $sql2 = "SELECT Flight_id, arrival_time, departure_time, airport_departure_name, airport_arrival_name FROM FLIGHT f, AIRPORT a1, AIRPORT a2 WHERE f.airport_departure_name = a1.Name AND a1.cityName ='".$dep_airport."' AND f.airport_arrival_name = a2.Name AND a2.cityName ='".$arr_airport."    '";
...
<html>
	<head>
		...
		<meta property="og:url" content="http://causairlinebooking.000webhostapp.com/register.html">
...
<div id="bg">
	<div class="col-md-6 col-md-offset-3  form-group panel panel-default">
        ...
        <form class='panel body' method='post' action='saveregister.php'>
            <div class='col-md-12'>
                <label class='col-md-4'>First Name</label>
                <input type="text" name="firstname" placeholder="firstname" pattern="[A-Za-z]{1,15}">
            </div>
			 <div class='col-md-12'>
                <label class='col-md-4'>Last Name</label>
				<input type="text" name="lastname" placeholder="lastname" pattern="[A-Za-z]{1,15}">
			...
			<div class='col-md-12'>
                <label class='col-md-4'>citizenship</label>
